...
def encodeImageIntoBase64(croppedImagePath: str) -> bytes:
    ...
    Args:
        croppedImagePath (str): The path of the image file to be encoded.

    Returns:
        bytes: The Base64-encoded string representation of the image file.
    ...
    try:
        ...
        raise FileNotFoundError(f"The specified image file '{croppedImagePath}' does not exist.")